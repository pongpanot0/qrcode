  ...
  db.query(get, async(err,result)=>{
    ...
    if(result){
      ...
      .then(async (result) => {
        ...
        const URI = `${process.env.thinmoo}/sqRoom/extapi/add?accessToken=${accessToken}&extCommunityUuid=${company_uuid}&buildingUuid=${room_buildingUuid}&name=${room_name}&code=${code}&uuid=${room_uuid}`;
